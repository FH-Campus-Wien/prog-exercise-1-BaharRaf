...
public class App {
    ...
    public void sumOfLiterals(){
        // input your solution here
        /*'Z' = char
        0xfavce = Hexa Decimal (Integral Literals)
        012 = Octal Integer ( Integral Literals)
        80L - long
        44e-1f = Dezimal in Exponent dorm ( Floating Point Literals)
    ...
    public void transposedNumbers(){
        ...
        if (n<1000){
            ...
            System.out.println("The Number can only contain up to 3 Digits");
        }
    }
